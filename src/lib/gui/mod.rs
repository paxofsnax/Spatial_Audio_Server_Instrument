...
widget_ids! {
    pub struct Ids {
        ...
        source_editor_selected_soundscape_movement_noise_walk_speed_text,
        source_editor_selected_soundscape_movement_noise_walk_speed_slider,
        source_editor_selected_soundscape_movement_noise_walk_wobble_text,
        source_editor_selected_soundscape_movement_noise_walk_wobble_slider,
        source_editor_selected_soundscape_movement_noise_walk_dimensions_text,
        source_editor_selected_soundscape_movement_noise_walk_width_slider,
        source_editor_selected_soundscape_movement_noise_walk_height_slider,
        source_editor_selected_soundscape_movement_noise_walk_directional,
