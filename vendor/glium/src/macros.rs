                    ...
                    $(
                        (
                            ...
                            },
                            {
                                ...
                                // Antopia: upstream's `transmute(0usize)` null-reference trick trips rustc's
                                // UB traps (ud2/SIGILL) in optimised builds on rustc >= 1.5x.
                                // The reference is only used for type inference, never read.
